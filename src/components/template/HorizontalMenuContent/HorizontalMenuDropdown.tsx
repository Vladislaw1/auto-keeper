...
import type { CSSProperties, HTMLProps, Dispatch, SetStateAction, ReactNode } from 'react';
...
interface HorizontalMenuDropdownProps {
  ...
  menuContent?: (props: { styles: CSSProperties; handleDropdownClose: () => void }) => ReactNode;
}
...
const HorizontalMenuDropdown = (props: HorizontalMenuDropdownProps) => {
  ...
  const { floatingStyles, refs, context } = useFloating<HTMLButtonElement>({
    ...
    placement: isNested ? 'right-start' : dropdownLean ? 'bottom-start' : 'bottom',
    middleware: [
      offset({

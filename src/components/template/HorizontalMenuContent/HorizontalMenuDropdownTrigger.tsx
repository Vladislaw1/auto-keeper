...
interface AnchorProps extends HorizontalMenuNavLinkProps, HorizontalMenuDropdownTriggerCommonProps {
  asElement?: 'a';
  path: string;
...
const HorizontalMenuDropdownTrigger = (props: HorizontalMenuDropdownTriggerProps) => {

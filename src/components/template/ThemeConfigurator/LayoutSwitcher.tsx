...
import { setLayout } from '@/store/slices/themeSlice';
import {
...
const LayoutSwitcher = () => {
  ...
  const themeLayout = useAppSelector((state) => state.theme.layout);
  ...
  return (
    <div>
      <Segment
        ...
        value={[]}
        onChange={(val) => dispatch(setLayout(val as LayoutType))}
      >
              ...
              {({ onSegmentItemClick }) => {
                ...
                return (
                  <div className="text-center">
                    ...
                    <div className="mt-2 font-semibold">{layout.label}</div>
                  </div>
                );
              }}
            </Segment.Item>

...
>(props: SelectProps<Option, IsMulti, Group>) {
  ...
  const portalProps =
    menuPortalTarget || usePortal
      ? {
          menuPortalTarget:
            menuPortalTarget ?? (typeof document !== 'undefined' ? document.body : undefined),
          menuPosition: menuPosition ?? ('fixed' as const),
        }
      : {};
      ...
      classNames={
        {
          ...
          valueContainer: ({ isMulti, hasValue, selectProps }) =>
            cn(
              ...
              isMulti && hasValue && selectProps.controlShouldRenderValue ? 'flex' : 'grid',
            ),
          ...
          placeholder: () =>
            cn('select-placeholder', isSelectInvalid ? 'text-error' : 'text-gray-400'),

...
import { TbChevronDown, TbChevronUp, TbChevronRight, TbChevronLeft } from 'react-icons/tb';
...
const DropdownToggle = (props: DropdownToggleProps & HTMLProps<HTMLDivElement>) => {
  const {
    className,
    renderTitle,
    children,

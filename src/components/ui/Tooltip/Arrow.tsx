...
const Arrow = ({ placement, color }: ArrowProps) => {
  ...
  const getArrow = () => {
    switch (placement) {
      ...
      case 'right-end':
        return (
          <BsFillCaretLeftFill className={classNames(arrowDefaultClass, '-left-2 bottom-2')} />
        );
      case 'bottom':
        return (
          <BsFillCaretUpFill className={classNames(arrowDefaultClass, '-top-2 w-full left-0')} />
        );
      case 'bottom-start':
        return (
          <BsFillCaretUpFill className={classNames(arrowDefaultClass, '-top-2 left-0 ml-3')} />
        );
      case 'bottom-end':
        return (

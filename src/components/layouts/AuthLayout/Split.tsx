      ...
      <div className="bg-no-repeat bg-cover py-6 px-16 flex-col justify-center items-center hidden lg:flex bg-primary rounded-3xl">
        <div className="flex flex-col items-center gap-12">
          ...
          <div className="text-center max-w-[550px]">
            <h1 className="text-neutral">The easiest way to build your admin app</h1>
            <p className="text-neutral opacity-80 mx-auto mt-8 font-semibold">
              Experience seamless project management with Ecme. Simplify your workflow, and achieve
              your goals efficiently with our powerful and intuitive tools.
            </p>
          </div>
        </div>
      </div>
